...
public class TardisCatwalkRailsCornerBlock extends Block {

    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public TardisCatwalkRailsCornerBlock(Settings settings) {
        super(settings);
    ...
    public VoxelShape getOutlineShape(@NotNull BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        if (state.get(FACING) == Direction.NORTH) {
            ...
            return Stream.of(
                    ...
                    Block.createCuboidShape(-1, 6, -1, 0, 8, 16),
                    Block.createCuboidShape(0, 12, -1, 16, 14, 0),
                    Block.createCuboidShape(0, 6, -1, 16, 8, 0),
                    Block.createCuboidShape(-1, 12, -1, 0, 14, 16)
            ...
            return Stream.of(
                    ...
                    Block.createCuboidShape(16, 6, 0, 17, 8, 17),
                    Block.createCuboidShape(0, 12, 16, 16, 14, 17),
                    Block.createCuboidShape(0, 6, 16, 16, 8, 17),
                    Block.createCuboidShape(16, 12, 0, 17, 14, 17)
            ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
            ...
            return Stream.of(
                    Block.createCuboidShape(7, 0, 14, 9, 14, 16),
                    Block.createCuboidShape(0, 0, 7, 2, 14, 9),
                    Block.createCuboidShape(-1, 6, 16, 16, 8, 17),
                    Block.createCuboidShape(-1, 12, 0, 0, 14, 16),
                    Block.createCuboidShape(-1, 6, 0, 0, 8, 16),
                    Block.createCuboidShape(-1, 12, 16, 16, 14, 17)
            ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
