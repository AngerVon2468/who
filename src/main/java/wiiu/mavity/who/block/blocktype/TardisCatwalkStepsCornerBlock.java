...
public class TardisCatwalkStepsCornerBlock extends Block {

    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public TardisCatwalkStepsCornerBlock(Settings settings) {
        super(settings);
    ...
    public VoxelShape getOutlineShape(@NotNull BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        if (state.get(FACING) == Direction.NORTH) {
            ...
            return Stream.of(
                    ...
                    Block.createCuboidShape(5, 5, 3, 13, 7, 5),
                    Block.createCuboidShape(11, 5, 5, 13, 7, 11),
                    Block.createCuboidShape(3, 5, 5, 5, 7, 13),
            ...
            return Stream.of(
                    ...
                    Block.createCuboidShape(3, 5, 11, 11, 7, 13),
                    Block.createCuboidShape(3, 5, 5, 5, 7, 11),
                    Block.createCuboidShape(11, 5, 3, 13, 7, 11),
            ...
            return Stream.of(
                    Block.createCuboidShape(3, 5, 5, 5, 7, 11),
                    Block.createCuboidShape(11, 5, 5, 13, 7, 13),
                    Block.createCuboidShape(5, 5, 11, 11, 7, 13),
                    Block.createCuboidShape(3, 5, 3, 11, 7, 5),
            ...
            return Stream.of(
                    Block.createCuboidShape(11, 5, 5, 13, 7, 11),
                    Block.createCuboidShape(3, 5, 3, 5, 7, 11),
                    Block.createCuboidShape(5, 5, 3, 11, 7, 5),
                    Block.createCuboidShape(5, 5, 11, 13, 7, 13),
